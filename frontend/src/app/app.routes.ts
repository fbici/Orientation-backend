  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import('./recommendations/recommendations.routes').then(m => m.RECOMMENDATIONS_ROUTES)
      },
      {
        path: 'documents',
      ...
      {
        path: 'rules',
        loadChildren: () => import('./rules/rules.routes').then(m => m.RULES_ROUTES)
      },
      {
        path: 'notifications',
